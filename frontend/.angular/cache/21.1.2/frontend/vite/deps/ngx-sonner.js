...
function ToastComponent_Conditional_4_Conditional_4_Template(rf, ctx) {
  ...
  if (rf & 2) {
    let tmp_5_0;
    const ctx_r2 = ɵɵnextContext(2);
    ɵɵstyleMap(ctx_r2.cancelButtonStyle() ?? ctx_r2.toast().cancelButtonStyle);
...
function ToastComponent_Conditional_4_Conditional_5_Template(rf, ctx) {
  ...
  if (rf & 2) {
    let tmp_5_0;
    const ctx_r2 = ɵɵnextContext(2);
    ɵɵstyleMap(ctx_r2.actionButtonStyle() ?? ctx_r2.toast().actionButtonStyle);
